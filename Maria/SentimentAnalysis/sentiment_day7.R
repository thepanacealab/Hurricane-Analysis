...
allTweetsDay7<-dbGetQuery(conn,
 ...
 tweettext
FROM tweets_info 
WHERE tweetcreated BETWEEN '2017-09-22' AND '2017-09-23';
")
...
Sentimentscores_day7<-cbind("day"=rep(c(22),10), "sentiment"=rownames(Sentimentscores_day7),Sentimentscores_day7)
...
ggplot(data=Sentimentscores_day7,aes(x=sentiment,y=Score, group=1))+ geom_line()+
  ...
  xlab("Sentiments")+ylab("scores")+ggtitle("Sentiments of people on Sep 22th, 2017")
