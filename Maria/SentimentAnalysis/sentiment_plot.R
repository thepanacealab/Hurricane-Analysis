...
day11 <- readRDS("day11.Rds")
day12 <- readRDS("day12.Rds")
day13 <- readRDS("day13.Rds")
day14 <- readRDS("day14.Rds")
day15 <- readRDS("day15.Rds")
day16 <- readRDS("day16.Rds")
day17 <- readRDS("day17.Rds")
...
p <- ggplot(data=new,aes(x=day,y=Score, group=sentiment))+ geom_line(aes(color=sentiment))+
  ...
  xlab("Days")+ylab("scores")+ggtitle("Sentiments of people during Hurricane Maria (Day 1 = Sept 16: Day 17 = Oct 03)")
