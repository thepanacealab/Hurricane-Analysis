...
allTweetsDay4<-dbGetQuery(conn,
 ...
 tweettext
FROM tweets_info 
WHERE tweetcreated BETWEEN '2017-09-19' AND '2017-09-20';
")
...
Sentimentscores_day4<-cbind("day"=rep(c(19),10), "sentiment"=rownames(Sentimentscores_day4),Sentimentscores_day4)
...
ggplot(data=Sentimentscores_day4,aes(x=sentiment,y=Score, group=1))+ geom_line()+
  ...
  xlab("Sentiments")+ylab("scores")+ggtitle("Sentiments of people on Sep 19th, 2017")
