...
allTweetsDay10<-dbGetQuery(conn,
 ...
 tweettext
FROM tweets_info 
WHERE tweetcreated BETWEEN '2017-09-25' AND '2017-09-26';
")
...
Sentimentscores_day10<-cbind("day"=rep(c(25),10), "sentiment"=rownames(Sentimentscores_day10),Sentimentscores_day10)
...
ggplot(data=Sentimentscores_day10,aes(x=sentiment,y=Score, group=1))+ geom_line()+
  ...
  xlab("Sentiments")+ylab("scores")+ggtitle("Sentiments of people on Sep 25th, 2017")
