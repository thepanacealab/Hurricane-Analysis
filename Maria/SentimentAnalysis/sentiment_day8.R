...
allTweetsDay8<-dbGetQuery(conn,
 ...
 tweettext
FROM tweets_info 
WHERE tweetcreated BETWEEN '2017-09-23' AND '2017-09-24';
")
...
Sentimentscores_day8<-cbind("day"=rep(c(23),10), "sentiment"=rownames(Sentimentscores_day8),Sentimentscores_day8)
...
ggplot(data=Sentimentscores_day8,aes(x=sentiment,y=Score, group=1))+ geom_line()+
  ...
  xlab("Sentiments")+ylab("scores")+ggtitle("Sentiments of people on Sep 23th, 2017")
